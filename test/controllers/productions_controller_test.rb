...
class ProductionsControllerTest < ActionController::TestCase
  ...
  test "should create production" do
    assert_difference('Production.count') do
      post :create, production: { end_date: @production.end_date, play_id: @production.play_id, start_date: @production.start_date, theater_id: @production.theater_id }
    end
  ...
  test "should update production" do
    patch :update, id: @production, production: { end_date: @production.end_date, play_id: @production.play_id, start_date: @production.start_date, theater_id: @production.theater_id }
    assert_redirected_to production_path(assigns(:production))
  end
